...
describe Company do
  ...
  describe "attributes" do
    it "creates new instance given a valid attribute" do
      Company.create!(FactoryGirl.attributes_for(:company))
    end
  ...
  describe "validations" do
    ...
    it "rejects duplicate names" do
      ...
      company_with_duplicate_name = FactoryGirl.build(:company)
      company_with_duplicate_name.name = company.name
      company_with_duplicate_name.should_not be_valid
      company_with_duplicate_name.should have(1).error_on(:name)
    end
