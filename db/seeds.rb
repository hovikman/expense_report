...
Currency.create(:code => 'BAM', :name => 'Bosnia and Herzegovina Marka')
...
Currency.create(:code => 'FKP', :name => 'Falkland Islands Pound')
...
Currency.create(:code => 'MVR', :name => 'Maldives Rufiyaa')
